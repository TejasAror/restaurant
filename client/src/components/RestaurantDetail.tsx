...
const RestaurantDetail = () => {
  ...
  const placeholderImage = "/images/placeholder-restaurant.jpg"; // Your placeholder path
    ...
    <div className="max-w-6xl mx-auto my-10">
      <div className="w-full">
        <div className="relative w-full h-32 md:h-64 lg:h-72">
          <img
            src={singleRestaurant?.imageUrl || placeholderImage}
            alt={singleRestaurant?.restaurantName || "Restaurant image"}
